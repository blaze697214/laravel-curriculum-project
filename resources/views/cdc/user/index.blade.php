...
@section('content')
    ...
    <div class="bg-white p-6 rounded-xl shadow mb-10">
        ...
        <form method="POST" action="{{ route('cdc.users.store') }}" class="grid grid-cols-1 md:grid-cols-2 gap-4">
            @csrf
                ...
                <tbody class="divide-y">
                    ...
                    @foreach ($users as $user)
                        <tr class="hover:bg-gray-50 border-gray-200">
                            <form method="POST" action="{{ route('cdc.users.update', $user->id) }}">
                                @csrf
                                @method('PUT')
                            ...
                            <form method="POST" action="{{ route('cdc.users.destroy', $user->id) }}">
