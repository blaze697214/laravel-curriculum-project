                ...
                @forelse ($courses as $item)
                    @php
                        ...
                        $statusConfig = match($raw) {
                            ...
                            'moderator_approved' => ['label' => 'Moderator Approved','class' => 'bg-blue-100 text-blue-800'],
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4 text-xs text-gray-600 max-w-xs">
                            @if($remark)
                                <div class="bg-red-50 border border-red-200 rounded-lg p-2">
                                    <p class="font-medium text-red-700 mb-0.5">{{ $remark->givenBy->name ?? 'Moderator' }}</p>
                        ...
                        <td class="px-6 py-4 text-center">
                            ...
                            @elseif(in_array($raw, ['draft', 'moderator_rejected']))
                                <a href="{{ route('expert.syllabus.preview', $item['course']->id) }}">
                                    <button class="bg-yellow-500 hover:bg-yellow-600 text-white px-4 py-1.5 rounded-lg text-xs font-medium transition-colors">
