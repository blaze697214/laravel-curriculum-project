...
<head>
    <meta charset="UTF-8">
    <title>Course Expert Panel</title>
    ...
    <div class="w-55 h-screen bg-slate-900 text-slate-200 flex flex-col justify-between fixed">
        ...
        <div>
            ...
            <nav class="mt-4 space-y-1">
                ...
                <a href="/expert/dashboard" class="block px-6 py-3 hover:bg-slate-800 transition">
                    Dashboard
                </a>
                <a href="{{ route('expert.syllabus.index') }}" class="block px-6 py-3 hover:bg-slate-800 transition">
                    Syllabus Submission
                </a>
